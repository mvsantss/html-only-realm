    ...
    <section className="bg-landi-black py-12 px-6">
      <div className="container mx-auto max-w-4xl">
        <div className="flex flex-col items-start gap-3 mb-6">
          <img src={grafismoVermelho} alt="" className="h-6 w-auto" />
        ...
        <div className="grid grid-cols-1 gap-10 mb-12">
          <div className="flex flex-col items-center">
            <h3 className="text-landi-white text-lg font-semibold mb-6 uppercase tracking-widest">
              APOIO
            </h3>
        ...
        <div className="flex flex-col items-center">
          <h3 className="text-landi-white/70 text-base font-medium mb-6 uppercase tracking-widest">
            PATROCINADORES
          </h3>
          <div className="flex flex-wrap items-center justify-center gap-8">
            <img
