...
export const LocationDesktop = () => {
  return (
    <section className="relative bg-landi-white py-12 md:py-16 px-6 overflow-hidden">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-6 text-landi-black">
            <div>
              ...
              <p className="text-sm leading-relaxed text-landi-black/70">
            ...
            <div className="pt-4">
              <p className="text-base text-landi-black/80">
                <strong>Ponto de referência:</strong><br />
                Entrada de Avaré, próximo ao McDonalds
              </p>
            </div>

            <div className="pt-8 mt-8 border-t border-landi-black/10">
              <a 
